...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28802692839942617)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(29653782046423263)
,p_plug_template_id=>wwv_flow_api.id(28802692839942617)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(29654287574423263)
,p_plug_template_id=>wwv_flow_api.id(28802692839942617)
,p_name=>'Tabs'
