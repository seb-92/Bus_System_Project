...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28795817095942614)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(29634552029423252)
,p_plug_template_id=>wwv_flow_api.id(28795817095942614)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(29635030964423252)
,p_plug_template_id=>wwv_flow_api.id(28795817095942614)
,p_name=>'Sub Regions'
