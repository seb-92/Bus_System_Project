...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28776232607942605)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(29589292512423224)
,p_plug_template_id=>wwv_flow_api.id(28776232607942605)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(29589740876423225)
,p_plug_template_id=>wwv_flow_api.id(28776232607942605)
,p_name=>'Sub Regions'
