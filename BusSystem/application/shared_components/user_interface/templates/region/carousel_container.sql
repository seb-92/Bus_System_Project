...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28769055227942601)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(29573121608423214)
,p_plug_template_id=>wwv_flow_api.id(28769055227942601)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(29573689079423215)
,p_plug_template_id=>wwv_flow_api.id(28769055227942601)
,p_name=>'Slides'
