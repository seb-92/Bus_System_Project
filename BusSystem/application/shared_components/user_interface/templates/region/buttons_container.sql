...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(28765812021942600)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(29565911472423210)
,p_plug_template_id=>wwv_flow_api.id(28765812021942600)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(29566467867423210)
,p_plug_template_id=>wwv_flow_api.id(28765812021942600)
,p_name=>'Sub Regions'
