...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(28915638709942685)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(28915720947942685)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(28915838007942685)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(28915638709942685)
,p_button_name=>'NEXT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(28915957342942686)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(28918578934942687)
,p_branch_name=>'Go To Next Step'
,p_branch_action=>'f?p=&APP_ID.:10014:&SESSION.::&DEBUG.:RP,10014::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(28915838007942685)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28918938516942687)
,p_name=>'P10013_ROLE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(28915720947942685)
,p_item_default=>'2'
,p_prompt=>'Role'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28919395986942687)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(28919788478942688)
...
,p_lov=>'.'||wwv_flow_api.id(28919803278942688)||'.'
,p_field_template=>wwv_flow_api.id(28858235150942645)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_attribute_01=>'1'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(28916086659942686)
,p_name=>'Cancel Modal'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(28915957342942686)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(28921186796942689)
,p_event_id=>wwv_flow_api.id(28916086659942686)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(28921695836942689)
...
,p_process_when_button_id=>wwv_flow_api.id(28915838007942685)
);
